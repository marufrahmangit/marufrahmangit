...
[![Security & Compliance](https://img.shields.io/badge/Website-marufrahman.dev-blue)]([https://sec.marufrahman.dev](https://sec.marufrahman.dev/category/security-research-and-audit/))
...
## About Me
I build secure and scalable AI-assisted software, automation workflows, and integrations that solve real operational problems.

My background spans software engineering, systems analysis, security and production delivery across regulated and compliance-mandated healthcare SaaS, enterprise systems, and hands-on business operations through my own eCommerce platform. I work well in environments where requirements are ambiguous, systems need to integrate cleanly, and the solution has to function reliably beyond a demo.
